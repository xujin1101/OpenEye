package com.eye.eyepetizer.discover.panorama.share;

import android.widget.ListView;

import com.eye.eyepetizer.R;
import com.eye.eyepetizer.base.BaseFragment;
import com.eye.eyepetizer.discover.panorama.time.PanoramaTimeAdapter;
import com.eye.eyepetizer.discover.panorama.time.PanoramaTimeBean;
 ...
 * 全景Fragment
 */
public class PanoramaShareFragment extends BaseFragment {
    private ListView mListView;
    private PanoramaTimeAdapter mAdapter;
    private PanoramaTimeBean mBean;

    private String url = "http://baobab.wandoujia.com/api/v3/tag/videos?tagId=658&strategy=shareCount&udid=cd1ee9c5b44e4f9487a505a4fe31ddcb07441cc8&vc=121&vn=2.3.5&deviceModel=MI%205&first_channel=eyepetizer_xiaomi_market&last_channel=eyepetizer_xiaomi_market&system_version_code=23";
    @Override
