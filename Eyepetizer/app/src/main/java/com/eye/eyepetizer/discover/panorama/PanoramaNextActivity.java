package com.eye.eyepetizer.discover.panorama;
...
import com.eye.eyepetizer.discover.glideview.GlideViewNextAdapter;
import com.eye.eyepetizer.discover.panorama.share.PanoramaShareFragment;
import com.eye.eyepetizer.discover.panorama.time.PanoramaTimeFragment;
 ...
 * 这周日你有空吗
 */
public class PanoramaNextActivity extends BaseActivity {
    ...
    protected void initDate() {
        ...
        fragments.add(new PanoramaTimeFragment());
        fragments.add(new PanoramaShareFragment());
